...
SELECT profile_id, account_id, first_name, last_name, profile_image_key
from profile;
...
INSERT INTO currency(currency_name, currency_symbol, currency_code, created_at)
VALUES ('Turkish lira', '₺', 'TRY', CURRENT_TIMESTAMP);
INSERT INTO currency(currency_name, currency_symbol, currency_code, created_at)
VALUES ('United States Dollar', '$', 'USD', CURRENT_TIMESTAMP);
INSERT INTO currency(currency_name, currency_symbol, currency_code, created_at)
VALUES ('Euro', '€', 'EUR', CURRENT_TIMESTAMP);